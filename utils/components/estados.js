module.exports = function EstadosComponent(){
    ...
    this.get = function GetMethodEstadosComponents(filters){
    ...
    this.cidadesOf = function CidadesOfEstadosComponents(estadoSigla){
        ...
        var promise = new Promise(function(accept, reject){
            ...
            var estadoFiltered = estados.filter(function(element){
                return element.sigla === estadoSigla;
            })[0];

            accept(estadoFiltered.cidades);
